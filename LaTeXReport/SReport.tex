...
{\vspace*{50mm}\textsc{\Huge\textbf{Bloom-Filter + Locality-filter}\\ \small{Métodos Probabilísticos para Engenharia Informática}}\\[2cm]
...
\title{\textbf{Bloom-Filter + Locality-filter}\\[1cm]\textsc{\small {Departamento de Electrónica, Telecomunicações e Informática} \\ \large {UNIVERSIDADE DE AVEIRO}}}
...
\begin{figure}[ht]	
\center
\fbox{\includegraphics[height=7cm]{img/test_HashFunction_distribution}}
...
\begin{figure}[ht]	
\center
\fbox{\includegraphics[height=7cm]{img/test_HashFunction_decorrelation}}
...
\begin{figure}[ht]	
\center
\fbox{\includegraphics[height=7cm]{img/test_OptimalK}}
...
\begin{figure}[ht]	
\center
\fbox{\includegraphics[height=7cm]{img/test_OptimalN_img}}
...
\begin{figure}[ht]	
\center
\fbox{\includegraphics[height=7cm]{img/test_OptimalN_text}}
...
\begin{figure}[ht]	
\center
\fbox{\includegraphics[height=7cm]{img/test_big_BloomFilter}}
...
\begin{figure}[ht]	
\center
\fbox{\includegraphics[height=7cm]{img/sr1}}
...
\begin{figure}[ht]	
\center
\fbox{\includegraphics[height=7cm]{img/sr3}}
...
\begin{figure}[ht]	
\center
\fbox{\includegraphics[height=7cm]{img/sr2}}
